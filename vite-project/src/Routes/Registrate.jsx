...
<div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form className="space-y-6" action="#">
        ...
        <div>
            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Coloca tu email</label>
            <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required />
        </div>
        <div>
            <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Coloca tu contraseña</label>
        ...
        <div className="flex items-start">
            <div className="flex items-start">
                ...
                <label htmlFor="remember" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Recordar siempre</label>
            </div>
        ...
        <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
            No estas registrado? <a href="#" className="text-blue-700 hover:underline dark:text-blue-500">Create una cuenta</a>
        </div>
    </form>
</div>
  )
